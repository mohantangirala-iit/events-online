...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '3438af20-312e-4679-a609-63838f0e89d4' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('6469fd72-ad07-4d04-8bdb-eb331faf065d');
      cy.get(`[data-cy="name"]`).should('have.value', '6469fd72-ad07-4d04-8bdb-eb331faf065d');
