...
import { sampleWithRequiredData } from '../person-type.test-samples';
...
describe('PersonType Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.personTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to personTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPersonTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPersonTypeIdentifier).toHaveBeenCalledWith(entity);
