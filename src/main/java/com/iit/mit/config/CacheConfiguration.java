...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.iit.mit.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.iit.mit.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.iit.mit.domain.User.class.getName());
            createCache(cm, com.iit.mit.domain.Authority.class.getName());
